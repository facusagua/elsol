      ...
      <div class="single-slide">
        ...
        <div class="slide-content">
            <div class="row">
                ...
                <div class="col-md-3 col-xs-5" style="background-color:">
                    <img src="assets/images/LOGO%20CON%20SOPORTE.png" style="width:80%;">
                </div>
                <div class="col-md-4 col-xs-1"></div>
              <div class="col-md-4 col-xs-5">
                <div class="slider-img wow fadeInUp" style="margin-top:100px;">
                  <img src="assets/images/man1.png" alt="business man">
                </div>
              </div>
            </div>
